export const proxyPermitRouterAbi = [
  {
    inputs: [
      {
  ...
  },
  {
    ...
    name: 'permitProxyCallDiffsWithMeta',
    outputs: [
      {
        internalType: 'bytes',
        name: '',
